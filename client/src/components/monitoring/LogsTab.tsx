 ...
 * Logs Tab Component
 *
 * Displays file access logs and audit logging controls.
 * This is an embedded version of Logging page for use in SystemMonitor tabs.
 */
...
export function LogsTab() {
  ...
  const [fileAccessLogs, setFileAccessLogs] = useState<FileAccessLogsResponse | null>(null);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
        <div>
          <h2 className="text-lg font-semibold text-white">{t('logging.title')}</h2>
      ...
      <div className="card border-slate-800/60 bg-slate-900/55 p-4 sm:p-6">
        <div className="flex flex-col gap-3 mb-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-white">{t('logging.fileAccessLogs')}</h3>
          </div>
