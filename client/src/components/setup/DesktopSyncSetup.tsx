  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-lg font-semibold text-slate-100">BaluDesk – Desktop-Sync</h2>
          <p className="text-sm text-slate-400">Automatische Synchronisierung für Windows & Linux</p>
        </div>
      </div>
      ...
      <div className="px-4 py-3 rounded-lg bg-slate-800/40 border border-slate-700 mb-5">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm font-medium text-slate-100">BaluDesk herunterladen</p>
            <p className="text-xs text-slate-400">Windows &amp; Linux – kostenlos</p>
          </div>
          <a
      ...
      <div className="rounded-lg border border-sky-800/50 bg-sky-900/10 p-4 mb-6">
        <div className="flex gap-3">
          ...
          <p className="text-sm text-sky-300/80">
            ...
            <strong className="text-sky-300">Gerätekopplung</strong> mit Ihrem NAS.
            Sync-Ordner werden dann im Bereich <strong className="text-sky-300">Geräte</strong>{' '}
            verwaltet.
          </p>
        </div>
      </div>
