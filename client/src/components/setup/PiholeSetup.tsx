  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-lg font-semibold text-slate-100">Pi-hole DNS</h2>
          <p className="text-sm text-slate-400">Netzwerkweite Werbeblockierung</p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between px-4 py-3 rounded-lg bg-slate-800/40 border border-slate-700 mb-5">
        <div>
          <p className="text-sm font-medium text-slate-100">Pi-hole-Integration aktivieren</p>
          <p className="text-xs text-slate-400">Verbindet BaluHost mit einem Pi-hole-Server</p>
        </div>
        <button
          type="button"
      ...
      <div className="rounded-lg border border-sky-800/50 bg-sky-900/10 p-4 mb-6">
        <div className="flex gap-3">
          ...
          <p className="text-sm text-sky-300/80">
            ...
            <strong className="text-sky-300">Pi-hole</strong>. Pi-hole muss separat installiert
