...
class Settings(BaseSettings):
    ...
    # Setup wizard
    skip_setup: bool = False  # env: SKIP_SETUP — skip wizard, use env-var admin creation
    setup_secret: str = ""  # env: SETUP_SECRET — if set, required for admin creation endpoint
