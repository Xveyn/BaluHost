...
| **Backend code** | 186,407 lines across 1,018 Python files |
| &nbsp;&nbsp;↳ Application (`app/`) | 110,959 lines / 485 files |
| &nbsp;&nbsp;↳ Tests (`tests/`) | 59,161 lines / 345 files |
| &nbsp;&nbsp;↳ Scripts (`scripts/`) | 6,306 lines / 48 files |
| &nbsp;&nbsp;↳ Alembic migrations | 7,004 lines / 113 files |
| &nbsp;&nbsp;↳ Terminal UI (`baluhost_tui/`) | 2,977 lines / 27 files |
| **Frontend code** | 87,317 lines across 536 source files (`client/src/`, .ts/.tsx/.js/.jsx/.css) |
| **Test functions** | 3677 |
| **API route modules** | 66 |
| **Service modules** | 202 |
| **Database models** | 53 |
| **Database migrations** | 112 |
| **Frontend pages** | 33 |
| **CI/CD workflows** | 10 |

<sub>LOC counted via `git ls-files` (respects `.gitignore`, excludes virtualenvs, `node_modules/`, `dist/`, caches, dev-storage). Last measured 2026-06-28.</sub>
<!-- STATS:PROJECT:END -->
