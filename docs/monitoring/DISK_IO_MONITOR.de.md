...
- Historische Daten werden in der Datenbank gespeichert (`disk_io_samples`-Tabelle)
- SMART-Daten und Disk-Temperaturen werden über den Monitoring Orchestrator erfasst
