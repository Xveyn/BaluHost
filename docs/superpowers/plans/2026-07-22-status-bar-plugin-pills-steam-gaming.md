...
- [x] **Step 3: Add the library-directory helper**
...
- [x] **Step 4: Write the name resolver**
...
- [x] **Step 3: Open up the pill-id type**
...
- [x] **Step 4: Update the catalog type annotation**
...
- [x] **Step 5: Replace the old drift test**
...
- [x] **Step 6: Add the plugin-side API**
...
- [x] **Step 7: Add a public accessor on the manager**
...
- [x] **Step 5: Verify plugin discovery still works**
...
- [x] **Step 6: Branch the config row**
...
- [x] **Step 1: Document the extension point**
...
- [x] **Step 2: Run the full affected backend suites**
...
- [x] **Step 3: Lint everything touched**

Run: `cd backend && python -m ruff check app tests`
Expected: `All checks passed!`

- [x] **Step 4: Manual verification in dev mode**
